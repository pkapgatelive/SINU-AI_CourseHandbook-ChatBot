  ...
  return (
    ...
    >
      ...
      >
        ...
        <button
          className="relative px-6 py-3 bg-white rounded-full shadow-lg hover:shadow-xl transition-all duration-200 flex items-center space-x-3 min-w-[620px] text-left"
          onFocus={onFocus}
        >
